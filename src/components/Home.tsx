  ...
  return (
    <div className="flex flex-col w-full relative">
      <div id="hero-container" className="relative h-[900px] w-full overflow-hidden group">
        ...
        <div className="absolute inset-0 bg-cover bg-center transition-transform duration-[20s] ease-in-out group-hover:scale-105" style={{ backgroundImage: 'url("https://yt3.googleusercontent.com/7y8KChJI_huixiWRFJGfK9-t5E3d7LMvZQN7QdJ2VHdTn8MIwFIH9Mohj0mKmaSGzWlns_ujRQ=w1707-fcrop64=1,00005a57ffffa5a8-k-c0xffffffff-no-nd-rj")' }}>
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
              {dynamicNews.map((news) => (
                <div key={news.id} className="bg-base-100 rounded-[2rem] shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden border border-neutral/20 flex flex-col h-full group transform hover:-translate-y-2">
